...
// Here we've created a byLength type that is just an alias for the
// builtin []string type
...
// Len and Swap will usually be similar across type and Less will
// hold the actual custom sorting logic. In our case we want to sort in order
