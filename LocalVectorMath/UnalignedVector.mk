...
CPPOPT_FLAGS = -Ox
C_FLAGS = -nologo -c -MD -LD -W3 -I. -D__BUILD_LIBRARY -D__UNALIGNED_LIB
...
ASM_FLAGS = -fwin32 -D__BUILD_UNALIGNED_LIB
...
DLL    = UnalignedVector
DLL1   = CUnalignedVector

!IFNDEF DEBUG
DLLOUT  = UnalignedVector
DLL1OUT = CUnalignedVector
!ELSE
DLLOUT  = UnalignedVectorDbg
DLL1OUT = CUnalignedVectorDbg
!ENDIF
