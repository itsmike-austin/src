...
CPPOPT_FLAGS = -Ox
C_FLAGS = -nologo -c -MD -LD -W3 -I. -D__BUILD_LIBRARY -D__ADVANCED_UNALIGNED_LIB
...
ASM_FLAGS = -fwin32 -D__BUILD_ADVANCED_UNALIGNED_LIB
...
DLL  = AdvancedUnalignedVector
DLL1 = CAdvancedUnalignedVector

!IFNDEF DEBUG
DLLOUT  = AdvancedUnalignedVector
DLL1OUT = CAdvancedUnalignedVector
!ELSE
DLLOUT  = AdvancedUnalignedVectorDbg
DLL1OUT = CAdvancedUnalignedVectorDbg
!ENDIF
