...
CPPOPT_FLAGS = -Ox
C_FLAGS = -nologo -c -MD -LD -W3 -I. -D__BUILD_LIBRARY -D__ALIGNED_LIB
...
ASM_FLAGS = -fwin32 -D__BUILD_ALIGNED_LIB
...
!IFNDEF DEBUG
DLLOUT  = AlignedVector
DLL1OUT = CAlignedVector
!ELSE
DLLOUT  = AlignedVectorDbg
DLL1OUT = CAlignedVectorDbg
!ENDIF
