...
//	private static final UUID MY_UUID_SECURE   = UUID.fromString("01111001-1101-1101-2201-020111101010");
	...
	// Start the ConnectThread to initiate a connection to the remote device
	...
	{
		if (D) Log.d(TAG,"connected, SocketType: " + socketType);
	...
	// Write to the ConnectedThread in an unsynchonized manner
	...
	public void write(byte[] out)
	{
		...
		// Synchronize a copy opf the ConnectedThread
	...
	private class AcceptThread extends Thread
	{
		...
		public void cancel()
		{
			if (D) Log.d(TAG,"SocketType" + mSocketType + "cancel" + this);
			try {
				mmServerSocket.close();
			} catch (IOException e) {
				Log.e(TAG,"Socket Type" + mSocketType + "close() or server failed",e);
			}
		}
	}
	...
	private class ConnectedThread extends Thread
	{
		...
		// Write to theconnected OutStream
		...
		public void cancel()
		{
			try {
				...
				Log.e(TAG,"close() of connectsocket failed",e);
			}
		}
	}
}