...
public class BluetoothChatActivity extends Activity
{
	...
	public void onStart()
	{
		...
		// If BT is not on, requwest that it be enabled.
	...
	public synchronized void onResume()
	{
		...
		if ( mChatService != null ) {
			// Only if the state is STATE_NONE, do we know that we haven't started yet
	...
	private void setupChat()
	{
		...
		mSendButton.setOnClickListener(new View.OnClickListener() {
			@Override public void onClick(View v) {
				// Send a message using the EditText widget content
	...
	// The action listener for the EditText widget; listens for the return key
