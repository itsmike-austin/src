...
import com.example.wifidirectdemo.DeviceListFragment.DeviceActionListener;
...
public class WiFiDirectActivity extends Activity implements ChannelListener, DeviceActionListener
{
	...
	public void setIsWifiP2pEnabled(boolean isWifiP2pEnabled) { this.isWifiP2pEnabled = isWifiP2pEnabled; }
	...
	// Remove all peers and clear all fields. This is called on BroadcastReceiver
	// receiving a state change event.
	...
	public void resetData()
	{
		...
		if ( fragmentList    != null ) fragmentList.clearPeers();
		if ( fragmentDetails != null ) fragmentDetails.resetViews();
	}
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
		...
		case R.id.atn_direct_enable:
			...
			if ( true != wifi.isWifiEnabled() ) wifi.setWifiEnabled(true);
	...
	public void onChannelDisconnected()
	{
		...
		if ( manager != null && !retryChannel ) {
			...
			Toast.makeText(this,"Severe! Channel is probably lost permenantly. Try Disable/Re-Enable P2P.",Toast.LENGTH_LONG).show();
		}
	}
		...
		if ( manager != null ) {
			...
			if ( fragment.getDevice() == null || fragment.getDevice().status == WifiP2pDevice.CONNECTED ) {
				...
				manager.cancelConnect(channel, new ActionListener() {
					@Override public void onSuccess() {
						Toast.makeText(WiFiDirectActivity.this, "Aborting connetion.", Toast.LENGTH_SHORT).show();
					}
					@Override public void onFailure(int reasonCode) {
