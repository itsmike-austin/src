...
public class DeviceDetailFragment extends Fragment implements ConnectionInfoListener
{
	...
	{
		// User has picked an image. Transfer it to group owner (i.e. peer) using FileTransferServices
	...
	public static class FileServerAsyncTask extends AsyncTask<Void,Void,String>
	{
		...
		@Override protected void onPreExecute() { statusText.setText("Opening a new server socket"); }		
	}
	...
	public static boolean copyFile(InputStream inputStream,OutputStream out)
	{
		...
		try {
			while( (len = inputStream.read(buf)) != -1 ) out.write(buf,0,len);
			out.close();
			inputStream.close();
		} catch (IOException e) {
